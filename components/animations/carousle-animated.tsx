...
export default function Carousel({
    ...
    return (
        <div
            ...
            style={{
                width: round ? `${baseWidth}px` : `${containerWidth}px`,
                height: round ? `${baseWidth}px` : `${containerHeight}px`,
            }}
        >
            <motion.div
                className="flex"
                ...
                {carouselItems.map((item, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            style={{
                                width: itemWidth,
                                height: round ? itemWidth : containerHeight - 32,
                                rotateY: rotateY,
                        ...
                        >
                            <div className="p-5 flex  flex-col items-center justify-center">
                                <div className="mb-1 font-black text-4xl text-background">
                                    {item.title}
                                </div>
                                <p className="text-base text-background">{item.description}</p>
                            </div>
                        </motion.div>
                    );
                })}
